...
function takeCommand(message){
   voice.style.display="none"
    ...
    if(message.includes("hello")||message.includes("hey")){
        speak("hello sir,what can i help you for you today!?")
    }
    else if(message.includes("who are you")||message.includes("what is your name")){
        speak("i am virtual assistant ,created by Asharaf Sir")
        ...
        speak("goodbye sir anything you want means call me sir")
    }
    else if(message.includes("good morning")){
        speak("goodmorning have a great day sir")
    }
    else if(message.includes("good afternoon")){
        speak("goodafternoon sir have you ate lunch sir")
    }
    else if(message.includes("good night")){
        speak("goodnight sir love you 3000 times")
    }
